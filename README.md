# 👋 Hi, I'm Yaroslav Syuzev! / Привет, я Ярослав Сюзев!

🚀 **React Developer** | Frontend Engineer | UI/UX Enthusiast

I build responsive, performant, and user-friendly web applications using the modern React ecosystem. Transitioning from a strong background in Android development (Kotlin, Clean Architecture), I now focus on crafting exceptional web experiences with reusable components and optimized state management.

Я создаю адаптивные, производительные и удобные веб-приложения с использованием экосистемы React. Имея сильный бэкграунд в Android-разработке (Kotlin, Clean Architecture), я сфокусировался на создании превосходного веб-опыта с переиспользуемыми компонентами и оптимизированным управлением состоянием.
...
### ⚙️ Tools & Practices / Инструменты и практики
...
- 🧮 **[Calculator](https://github.com/yaroslavss/calculator)**  
...
- 🪟 **[Modal Window](https://github.com/yaroslavss/modal-window)**  
  *EN:* A reusable modal component demonstrating advanced state management and elimination of "prop drilling".  
